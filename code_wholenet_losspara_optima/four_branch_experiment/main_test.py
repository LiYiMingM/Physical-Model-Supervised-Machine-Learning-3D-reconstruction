...
def get_args():
    parser = OptionParser()
    #测试时结果保存的位置
    parser.add_option('-e', '--result', dest='result', default="Result/Qian_1000/Wholenet/ResUnet_5_22/weights_single-1.0-1.0-1.0-1000.0/tset", help='folder of results')
    parser.add_option('-r', '--root', dest='root', default="/home/lym_pcl/lym_dataset/Qian_1000/", help='root directory')
    ####测试时载入的权重
    parser.add_option('-m', '--model', dest='model', default='Result/Qian_1000/Wholenet/ResUnet_5_22/weights_single-1.0-1.0-1.0-1000.0.pth', help='folder for model/weights')
